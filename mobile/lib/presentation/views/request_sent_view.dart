...
class RequestSentView extends StatefulWidget {
  const RequestSentView({Key? key}) : super(key: key);

  @override
  State<RequestSentView> createState() => _RequestSentViewState();
}

class _RequestSentViewState extends State<RequestSentView> {
  double fem = 1;
  double ffem = 1;
